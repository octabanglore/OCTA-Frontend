export const productCatalogueIcon = (
  <svg
    width="24"
    height="24"
    viewBox="0 0 24 24"
  ...
  >
    <g clipPath="url(#clip0_2145_19081)">
      <path d="M7 19H17V4H7V19ZM9 6H15V17H9V6Z" fill="#282A3A" />
      <path d="M5 6H3V17H5V6Z" fill="#282A3A" />
      <path d="M21 6H19V17H21V6Z" fill="#282A3A" />
    </g>
    <defs>
      <clipPath id="clip0_2145_19081">
...
export const purchaseOrderIcon = (
  <svg
    ...
    xmlns="http://www.w3.org/2000/svg"
  >
    <g clipPath="url(#clip0_2145_19112)">
      <path
...
export const insightsIcon = (
  <svg
    ...
    xmlns="http://www.w3.org/2000/svg"
  >
    <g clipPath="url(#clip0_2145_19063)">
      <path
    ...
    <defs>
      <clipPath id="clip0_2145_19063">
        <rect width="24" height="24" fill="white" />
      </clipPath>
    </defs>
  </svg>
);
export const inventoryManageIcon = (
  <svg
    width="24"
    height="24"
    viewBox="0 0 24 24"
    ...
    xmlns="http://www.w3.org/2000/svg"
  >
    <g clipPath="url(#clip0_2145_19099)">
      <path
...
export const approvalsIcon = (
  <svg
    ...
    xmlns="http://www.w3.org/2000/svg"
  >
    <g clipPath="url(#clip0_2145_19126)">
      <path
...
export const logoutIcon = (
  <svg
    ...
    xmlns="http://www.w3.org/2000/svg"
  >
    <g clipPath="url(#clip0_2735_2174)">
      <path
